<template>
  <div class="entry-title d-flex justify-content-between p-2">
    ...
    <div>
        <span class="text-success fs-3 fw-bold">24</span>
  ...
  <img src="https://res.cloudinary.com/di5yiluz8/image/upload/v1682907039/techpulse-solutions-landing/pexels-tranmautritam-285814.jpg" 
       alt="entry-picture"
       class="img-thumbnail">
